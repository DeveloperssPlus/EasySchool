...
public partial class Communication_TaskAdd : MyPermisionPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            var lstIncoming = (from k in km.Incomings
                        where k.SchoolId == schoolId
                        orderby k.Number
                        select k).ToList();
            ddlIncoming.DataSource = lstIncoming;
            ddlIncoming.DataValueField = "FileLocation";
            ddlIncoming.DataTextField = "Number";
            ddlIncoming.DataBind();
