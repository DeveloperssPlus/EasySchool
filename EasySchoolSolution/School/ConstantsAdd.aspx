<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ConstantsAdd.aspx.cs" Inherits="School_ConstantsAdd" %>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <asp:DropDownList ID="ddlConstansType" runat="server" CssClass="form-control form-white chosen-select AutherDrop" AutoPostBack="true" DataSource="<%#ConstantManager.getSchoolTypes()%>" DataTextField="Type" DataValueField="Id"></asp:DropDownList>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <asp:HiddenField ID="schoolId" runat="server" />
                                    <asp:ListView ID="lstConstants" runat="server" OnDataBinding="lstConstants_DataBinding" OnItemCommand="lstConstants_ItemCommand">
                                        <LayoutTemplate>
