<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EmployeeWaitingAdd.aspx.cs" Inherits="EmployeeAttendence_EmployeeWaitingAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="Server">
    ...
    <div class="panel">
        <div class="panel-header">
            <div class="col-md-12">
                <h4><i class="fa fa-sign-out" aria-hidden="true"></i>اضافة جداول الانتظار</h4>
            </div>
        </div>
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        <asp:Label ID="Label3" runat="server" Text="اسم المعلم الغائب : "></asp:Label>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <asp:Label ID="Label6" runat="server" Text="تاريخ الغياب : "></asp:Label>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        <asp:Label ID="Label7" runat="server" Text="المادة :"></asp:Label>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <asp:Label ID="Label5" runat="server" Text="اسم المعلم المنتظر:"></asp:Label>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        <asp:Label ID="Label1" runat="server" Text="ما تم تنفيذه في حصة الانتظار :"></asp:Label>
                        <asp:TextBox ID="txtDo" runat="server" TextMode="MultiLine" CssClass="form-control form-white"></asp:TextBox>
    ...
    <div class="panel">
        <div class="panel-header">
            <div class="col-md-12">
                <h4><i class="fa fa-table" aria-hidden="true"></i>&nbsp; حصص الانتظار لمعلم غائب</h4>
            </div>
