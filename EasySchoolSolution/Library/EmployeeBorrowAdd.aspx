<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EmployeeBorrowAdd.aspx.cs" Inherits="Library_EmployeeBorrowAdd" %>
            ...
            <div class="panel">
                ...
                <div class="panel-content">
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            اسم الكتاب:
                                        <asp:DropDownList ID="ddlBookName" runat="server" Width="230px" class="chosen-select AutherDrop form-control form-white">
                                        </asp:DropDownList>
                        </div>
    ...
    <asp:PlaceHolder ID="PlaceHolderAddBorrow" runat="server" Visible="false">
        <div class="panel">
            ...
            <div class="panel-content">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <asp:Label ID="Label3" runat="server" Text="Label">اسم الموظف: </asp:Label>
                        <asp:DropDownList ID="ddlEmployee" runat="server" class="chosen-select AutherDrop form-control form-white" required></asp:DropDownList>
                    </div>
                </div>
                <br />
                <br />
