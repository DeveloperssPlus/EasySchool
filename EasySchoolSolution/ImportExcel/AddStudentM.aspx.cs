...
public partial class ImportExcel_AddExcel : MyPermisionPage
{
        ...
        if (FileUpload1.HasFiles)
        {
            foreach (var file in FileUpload1.PostedFiles)
            {
                ...
                if (extention == ".xlsx" || extention == ".xls")
                {
                    ...
                    //try
                    //{
                        ExcelManager.addStudentM(path, out add, out edit);
                        lblSuccess.Text = "تم اضافة " + add + " طالب بنجاح  <br> تم تعديل " + edit + " طالب بنجاح ";
