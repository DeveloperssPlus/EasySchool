...
public partial class ImportExcel_AddStudentGrade : MyPermisionPage
{
    protected override void OnPreInit(EventArgs e)
    {
        MyPer = "AddStudentGrade";
        base.OnPreInit(e);
    }
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //var StudentGradeList = (from k in km.StudentsGuides where k.SchoolId == schoolid select k).ToList();
        //ListView1.DataSource = StudentGradeList;
        //ListView1.DataBind();
    }
        ...
        if (FileUpload1.HasFiles)
        {
            foreach (var file in FileUpload1.PostedFiles)
            {
                ...
                if (extention == ".xlsx" || extention == ".xls")
                {
                    ...
                    //try
                    //{
                        ExcelManager.addStudentGrade(path);
