<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AddTables.aspx.cs" Inherits="ImportExcel_AddTables" %>
    ...
    <div class="col-md-12 portlets">
        <div class="panel">
            <div class="panel-heading">
                <h4 class="panel-title"><i class="fa fa-user-plus"></i>&nbsp; اضافة جداول الطلاب </h4>
            </div>
            ...
            <div class="panel-content">
                <div class="row">
                    <div class="portlet-body container" style="height: auto;">
                        <div class="row">
                            <div class="col-sm-3">
                                الرجاء اختيار ملفات جداول الطلاب ..
                                <br />
