<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AddStudentNumber.aspx.cs" Inherits="ImportExcel_AddStudentNumber" %>
    ...
    <div class="col-md-12 portlets">
        <div class="panel">
            <div class="panel-heading">
                <h4 class="panel-title"><i class="fa fa-user-plus"></i>&nbsp; اضافة الرقم الأكاديمي للطلاب </h4>
            </div>
            <div class="panel-content">
                <div class="row">
                    <div class="portlet-body container" style="height: auto;">
                        <div class="row">
                            <div class="col-sm-3">
                                         الرجاء اختيار ملفات الرقم الأكاديمي للطلاب..
                                <br />
            ...
            <div class="panel-content">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <a href="../Student/StudentRecord.aspx?IdentityNumber=<%#Eval("IdentityNumber") %>"><%# Eval("Name") %></a>
                            </td>
                            <td>
                                <%# Eval("IdentityNumber") %>
                            </td>
