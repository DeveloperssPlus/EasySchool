<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AddTeachers.aspx.cs" Inherits="ImportExcel_AddTeachers" %>
    ...
    <div class="col-md-12 portlets">
        <div class="panel">
            <div class="panel-heading">
                <h4 class="panel-title"><i class="fa fa-user-plus"></i>&nbsp; اضافة المعلمين </h4>
            </div>
        ...
        <div class="panel panel-blue margin-bottom-40">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-users"></i>&nbsp; عرض المعلمين </h3>
            </div>
            <div class="panel-content">
