<%@ Page Language="C#" AutoEventWireup="true" CodeFile="form15.aspx.cs" Inherits="SchoolForms_form15" %>
...
<div class="container-fluid">
       ...
       <div class="container content" align="center">
           ...
           <div class="row sub-title">
               <div class="col-xs-6">
                  <h5>اسم النموذج : سجل الصادر العام</h5>
               </div>
               
               <div class="col-xs-6">
                   <h5>رمز النموذج : (م.م.ع.ن- 02 - 03)</h5>
               </div>
  ...
  <tr>
    ...
    <th class="text-center" style="font-size:15px">رقم الصادر</th>
