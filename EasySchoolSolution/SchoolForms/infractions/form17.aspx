<%@ Page Language="C#" AutoEventWireup="true" CodeFile="form17.aspx.cs" Inherits="infractions_نماذج_form17" %>
    ...
    <form id="form1" runat="server">
        <div class="container content" align="center">
            ...
            <div class="col-xs-12">
                ...
                <h3 style="font-weight:900;">إشعار ولي الأمر</h3>
             </div>
            <div class="row">
                ...
                <div class="col-xs-12" style="text-align:right">
                    <h3>نظرً ا لارتكاب ابنكم / ابنتكم مخالفة سلوكية من الدرجة <asp:Literal ID="ltrLevel" runat="server" Text=".................."></asp:Literal> وفق ما نصت عليه قواعد السلوك والمواظبة.</h3>
                    <h3>عليه نشعركم بقرار سعادة وكيل الوزارة للتعليم رقم/<asp:Literal ID="ltrDecisionNumber" runat="server" Text=".............."></asp:Literal> و تاريخ <asp:Literal ID="ltrDecisionDate" runat="server" Text="&shy; &shy;  &shy; &shy; /  &shy; &shy;  &shy; &shy; / &shy; <b>14هــ</b>"></asp:Literal></h3>
                    <h3>بتطبيق الإجراءات وفق قواعد السلوك والمواظبة وهي حرمان ابنكم /ابنتكم من الدراسة للعام الدراسي <asp:Literal ID="ltrYear" runat="server" Text="<b> &shy; &shy;14 هــ</b> - <b> &shy; &shy;14 هــ</b>"></asp:Literal> في جميع مدارس إدارات التعليم التابعة لوزارة التعليم على أن يعود طالباً منتظماً للعام الدراسي المقبـــــــــل <asp:Literal ID="ltrNextYear" runat="server" Text="<b> &shy; &shy; 14 هــ</b> - <b> &shy; &shy; 14 هــ</b>"></asp:Literal> في مدرسة أخرى . </h3>
                    <h3>عليه نأمل منكم مراجعة إدارة التعليم <asp:Literal ID="ltrDepartmentEducation" runat="server" Text="............................"></asp:Literal> في نهاية العام الدراسي الحالي <asp:Literal ID="ltrCurrentYear" runat="server" Text="<b> &shy; &shy; 14 هــ</b> - <b>  &shy; &shy; 14 هــ</b>"></asp:Literal> وذلك لإشعاركم بالمدرسة التي سينقل ابنكم / ابنتكم إليها والتزام ابنكم / ابنتكم بالحضور إلى وحدة الخدمات الإرشادية بإدارة التوجيه والإرشاد لتطبيق برنامج
علاج سلوكي يسهم  في تعديل سلوكه/ها .</h3> 
             </div>
                <div class="col-xs-12">
