<%@ Page Language="C#" AutoEventWireup="true" CodeFile="form9.aspx.cs" Inherits="infractions_نماذج_form9" %>
    ...
    <form id="form1" runat="server">
        <div class="container content" align="center">
            ...
            <div class="row">
                ...
                <div class="col-xs-12" style="text-align:right">
                       <h3>  نظراً لارتكاب ابنكم/ابنتكم وارتكابه مخالفة سلوكية من الدرجة / <asp:Literal ID="ltrLevel" runat="server" Text="............................"></asp:Literal></h3>
                       <h3><b>وهي :</b> <asp:Literal ID="ltrViolation" runat="server" Text="...................................................................................."></asp:Literal></h3>
                       <h3>نفيدكم بأن لجنة التوجيه والإرشاد على مستوى المدرسة قد قررت حرمان الطالب/ة من الدراسة لمدة أسبوع اعتبارا من يوم <asp:Literal ID="ltrViolationStartDay" runat="server" Text="......................."></asp:Literal> الموافق <asp:Literal ID="ltrViolationStartDate" runat="server" Text="&shy; &shy; / &shy; &shy; / &shy;&shy; <b>14هــ</b>"></asp:Literal> إلى يوم <asp:Literal ID="ltrViolationEndDay" runat="server" Text="..........................................."></asp:Literal> الموافق <asp:Literal ID="ltrViolationEndDate" runat="server" Text=" &shy; &shy; / &shy; &shy; / &shy; &shy; <b>14هــ</b>"></asp:Literal>  حيث طبقت كافة الإجراءات المنصوص عليها التي تسبق القرار أعلاه وفق ما نصت عليه قواعد السلوك والمواظبة.</h3>
             </div>
                <div class="col-xs-12">
