<%@ Page Language="C#" AutoEventWireup="true" CodeFile="form10.aspx.cs" Inherits="infractions_نماذج_form10" %>
    ...
    <form id="form1" runat="server">
        <div class="container content" align="center">
            ...
            <div class="col-xs-12">
                ...
                <h3 style="font-weight:900;">إنذار نقل طالب/ة إلى مدرسة أخرى</h3>
            </div>
            <div class="row">
                ...
                <div class="col-xs-12" style="text-align:right">
                       ...
                       <h3>وحيث طبقت كافة الإجراءات المنصوص عليها في قواعد السلوك والمواظبة من مخالفات الدرجة <asp:Literal ID="ltrViolationLevel" runat="server" Text="..............."></asp:Literal></h3>
                       <h3>لذا نشعركم بأن ابنكم / ابنتكم سينتقل من المدرسة ألى مدرسة أخرى في حالة إعادة تكرار المخالفة وعدم الالتزام </h3>
                       <h3>بقواعد السلوك .</h3>
             </div>
                <div class="col-xs-12">
