<%@ Page Title="login" Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" UICulture="ar-SA" Inherits="_Login" %>
    ...
    <div class="container" id="login-block">
        ...
        <div class="account-form">
            <form class="form-signin" runat="server">
                <asp:Login ID="Login1" runat="server" OnLoggingIn="Login1_LoggingIn"  OnLoggedIn="Login1_LoggedIn" DestinationPageUrl="~/Default2.aspx" FailureText="هدا الحساب غير فعال">
                    <LayoutTemplate>
